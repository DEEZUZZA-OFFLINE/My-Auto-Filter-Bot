...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url='https://t.me/CINEMA_CITY_UPDATES'),
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('⚡️Cʜᴀɴɴᴇʟ', url='https://t.me/CINEMA_CITY_UPDATES'),
            InlineKeyboardButton('🍿Gʀᴏᴜᴘ', url='https://t.me/Mallu_Movie_Hub_Group')
            ],[
            InlineKeyboardButton('🏠 Hᴏᴍᴇ', callback_data='start'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"ᴘᴀɢᴇ1/{round(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="ɴᴇxᴛ",callback_data=f"next_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="ɴᴏ ᴍᴏʀᴇ ᴘᴀɢᴇs ᴀᴠᴀɪʟᴀʙʟʙ",callback_data="pages")]
        )
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            await message.reply_photo(photo="https://telegra.ph/file/82b5bbbab6d5e5593b6b2.jpg", caption=(cap, reply_markup=InlineKeyboardMarkup(btn))
    else:
        await message.reply_photo(photo="https://telegra.ph/file/8b42f6caf6ef5fd76766f.jpg", caption=(cap, reply_markup=InlineKeyboardMarkup(btn))
    if spoll:
